// ---------------------------------------------------------------------------
// GET /api/admin/hermes/status — REAL Hermes health only.
// Until the Hermes contract is configured the honest answer is UNKNOWN.
// When configured, the adapter's health() probe result is persisted to
